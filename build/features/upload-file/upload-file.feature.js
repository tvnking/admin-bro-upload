    ...
    const uploadFeature = admin_bro_1.buildFeature({
        properties: {
            [properties.file]: {
                ...
                components: {
                    edit: config.crop ? admin_bro_1.default.bundle('../../../src/features/upload-file/components/edit-crop') : admin_bro_1.default.bundle('../../../src/features/upload-file/components/edit'),
